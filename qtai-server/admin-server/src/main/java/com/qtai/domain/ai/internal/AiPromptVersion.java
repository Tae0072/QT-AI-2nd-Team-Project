...
public class AiPromptVersion {
    ...
    public static AiPromptVersion createDraft(
            AiPromptType promptType,
            String version,
            String contentHash,
            String systemPrompt,
        ...
        return new AiPromptVersion(
                ...
                requireText(userPromptTemplate, "userPromptTemplate"),
                modelName,
                temperature,
                maxTokens,
                description,
                requirePositive(createdByAdminId, "createdByAdminId"),
                createdAt,
                null,
                null
        );
    ...
    public void activate(OffsetDateTime activatedAt) {
        if (status != AiPromptVersionStatus.DRAFT) {
    ...
    public void retire(OffsetDateTime retiredAt) {
        if (status == AiPromptVersionStatus.RETIRED) {
            throw new BusinessException(ErrorCode.INVALID_STATUS_TRANSITION);
        }
        this.status = AiPromptVersionStatus.RETIRED;
