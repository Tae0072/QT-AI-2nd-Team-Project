...
dependencies {
    ...
    implementation("org.springframework.boot:spring-boot-starter-cache")  // CaffeineCacheManager(spring-context-support)
    implementation("com.github.ben-manes.caffeine:caffeine")               // BibleService @Cacheable("bibleBooks")
