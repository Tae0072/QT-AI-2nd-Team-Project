...
- [ ] QT 본문은 00:00 KST 공개 / 00:05 KST 내부 해설 job 시딩 / 04:00 KST 사용자 노출·cache refresh 기준
...
| 7 | 제품 요구사항 | 오늘 QT 00:00 공개/00:05 내부 해설 job 시딩/04:00 사용자 노출 기준, AI 배치 전용, 큐레이션 찬양, 시뮬레이터 상태 |
...
| ERD 문서 | `02_ERD_문서.md` v2.2 반영 |
| 구현 저장소 반영 체크리스트 | `22_구현_저장소_반영_체크리스트.md` v0.4 반영 |
| 기능 명세서 | `25_기능_명세서.md` v0.9 반영 |
| 화면 기능 정의서 | `06_화면_기능_정의서.md` v1.5 반영 |
| 시퀀스 다이어그램 | `05_시퀀스_다이어그램.md` v1.1 반영 |
| 아키텍처 정의서 | `03_아키텍처_정의서.md` v1.3 반영 |
| API 명세서 | `04_API_명세서.md` v1.7 반영 |
| 품질 게이트 | `18_코드_품질_게이트.md` v3.1 반영 |
| 도메인 용어사전 | `23_도메인_용어사전.md` v1.1 반영 |
