...
QT-AI는 사용자가 매일 오늘 QT 본문을 읽고, AI의 묵상 보조 응답과 함께 개인 묵상 노트를 자동 저장·관리하는 앱입니다.
...
> 2026-05-13 오전 회의 기준: MVP에서는 AI 질문과 묵상 기록이 오늘 QT 본문에만 연결됩니다. 자유 본문 Journal 생성과 일반 성경 AI 질문은 만들지 않습니다.
...
│   ├── bff-aggregator/   # today QT/passages aggregation + WS notification
...
> 추가 금지: 자유 본문 `POST /api/v1/journals`, 오늘 QT 외 AI 세션 생성, 직접 YouTube URL/가사/음원 제공, 교회 인증 필수 gate.
