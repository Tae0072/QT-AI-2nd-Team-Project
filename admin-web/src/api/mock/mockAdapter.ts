...
const db = {
  ...
  aiAssets: [
    ...
    { id: 604, assetType: 'EXPLANATION', targetType: 'QT_PASSAGE', targetId: 5, status: 'VALIDATING', promptVersion: { id: 801, promptType: 'EXPLANATION', version: 'v1.3', status: 'ACTIVE' }, checklistVersionId: 701, latestValidationResult: 'PASSED', autoValidationResult: 'PASSED', advisorValidationResult: 'PASSED', sourceLabelPresent: true, createdAt: T(0, 5) },
    { id: 605, assetType: 'EXPLANATION', targetType: 'BIBLE_VERSE', targetId: 1903, status: 'VALIDATING', promptVersion: { id: 801, promptType: 'EXPLANATION', version: 'v1.3', status: 'ACTIVE' }, checklistVersionId: 701, latestValidationResult: 'NEEDS_REVIEW', autoValidationResult: 'PASSED', advisorValidationResult: null, sourceLabelPresent: true, createdAt: T(0, 3) },
  ] as any[],
  ...
  promptVersions: [
    ...
    { id: 803, promptType: 'EXPLANATION', version: 'v1.5-draft', contentHash: null, status: 'DRAFT', systemPrompt: '당신은 성경 해설 보조자입니다. 단정·설교 표현을 피합니다.', userPromptTemplate: '본문: {{passage}}\n핵심 단어 풀이를 포함하세요.', modelName: 'deepseek-chat', temperature: 0.2, maxTokens: 1200, description: '단어 풀이 강화 초안', createdByAdminId: 1, createdAt: T(0, 12), activatedAt: null, retiredAt: null },
    { id: 804, promptType: 'EXPLANATION', version: 'v1.6-draft', contentHash: null, status: 'DRAFT', systemPrompt: '당신은 성경 해설 보조자입니다.', userPromptTemplate: '본문: {{passage}}\n출처 라벨을 반드시 포함하세요.', modelName: 'deepseek-chat', temperature: 0.3, maxTokens: 1400, description: '출처 라벨 필수화 초안', createdByAdminId: 1, createdAt: T(0, 4), activatedAt: null, retiredAt: null },
  ] as any[],
